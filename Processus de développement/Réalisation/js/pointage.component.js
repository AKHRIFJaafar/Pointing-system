    ...
    render() {
      ...
      class_name += this.props.pointage.presence == 1 ? ' ouvrier-success' : ' ouvrier-info';
        return (
              ...
              <td>{this.props.pointage.heurePointage}</td>
              <td></td>
              <td>
              <svg xmlns="http://www.w3.org/2000/svg" width={22} height={22} fill="currentColor" className="bi bi-check-square text-success" viewBox="0 0 16 16" onClick={this.props.PointerOuvrier}>
